...
//         <Slider {...settings1} className="cars-disp slide-track anu-carosel-hld1 part1">
...
//         </Slider>
//         <Slider {...settings2} className="cars-disp slide-track anu-carosel-hld1 part1">
//         <div className='item1'>
//               <div className='bgdiv'>
//                 <div className='hidden-content'>
...
//               <div className='bgdiv'>
//                 <div className='hidden-content'>
//                   <div className='heading-hide'>Nh7</div>
//                 </div>
//                 <div className='immage'>
//                 <a href="https://sketchmyplot.com/" target="_blank" ><img src={Nh7} alt="" />
//         </a>        </div>
