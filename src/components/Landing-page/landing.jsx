    ...
    <>
      <section className="hero_container" id="hero-home">
        ...
        <div className="hero_home_content">
          ...
          <span className="typewriter" style={{ color: "#fff" }}>
            Handling
          </span>
          <span
            className="typewriter"
            style={{ color: "#0090ee", fontWeight: "bold" }}
          >
            <Typewriter
          ...
          <div className="hero_home_content_desc">
            <span>
              Get ahead in this transformative world of online marketing with
              our full bodied strategies, well defined processes, and deep
              knowledge of tech!
            </span>
          </div>
        </div>
